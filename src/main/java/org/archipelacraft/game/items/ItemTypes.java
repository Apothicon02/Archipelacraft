...
public class ItemTypes {
    ...
    public static ItemType
            ...
            OAK_PLANK = create(new ItemType("component/texture/oak_plank").blockToPlace(BlockTypes.getId(BlockTypes.OAK_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            BIRCH_PLANK = create(new ItemType("component/texture/birch_plank").blockToPlace(BlockTypes.getId(BlockTypes.BIRCH_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            CHERRY_PLANK = create(new ItemType("component/texture/cherry_plank").blockToPlace(BlockTypes.getId(BlockTypes.CHERRY_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            MAHOGANY_PLANK = create(new ItemType("component/texture/mahogany_plank").blockToPlace(BlockTypes.getId(BlockTypes.MAHOGANY_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            ACACIA_PLANK = create(new ItemType("component/texture/acacia_plank").blockToPlace(BlockTypes.getId(BlockTypes.ACACIA_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            PALM_PLANK = create(new ItemType("component/texture/palm_plank").blockToPlace(BlockTypes.getId(BlockTypes.PALM_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            SPRUCE_PLANK = create(new ItemType("component/texture/spruce_plank").blockToPlace(BlockTypes.getId(BlockTypes.SPRUCE_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            WILLOW_PLANK = create(new ItemType("component/texture/willow_plank").blockToPlace(BlockTypes.getId(BlockTypes.WILLOW_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
            REDWOOD_PLANK = create(new ItemType("component/texture/redwood_plank").blockToPlace(BlockTypes.getId(BlockTypes.REDWOOD_PLANKS), 0).maxStackSize(64).sfx(new ItemSFX(new SFX[]{Sounds.WOOD_STEP1, Sounds.WOOD_STEP2}, 0.5f, 1.1f))),
